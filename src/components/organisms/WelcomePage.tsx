  ...
  return (
    <section className="border border-gray-200 rounded-lg shadow-lg py-8 text-center">
      <div className="container mx-auto px-4">
        ...
        <Link to="/cdl-clone/exam" className="inline-block border border-gray-200 rounded-lg shadow-lg text-white px-6 py-3 rounded-lg font-semibold bg-blue-500 hover:bg-blue-600">Take Exam</Link>
